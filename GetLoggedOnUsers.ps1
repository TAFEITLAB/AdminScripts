#Intro
Clear-Host;
Write-Host "GET LOGGED ON USERS `n" -ForegroundColor Blue -BackgroundColor White;
Write-Host "List logged-on users on a selected target list of nodes `n";
...
function GetLoggedOnUsers {
    ...
    #Write-Host "===" $PC "==="
    Get-WmiObject -ComputerName $Global:list -Class Win32_ComputerSystem | Select-Object PSComputerName,UserName | Format-Table -AutoSize
    #}
}
<# ------------ #>
<# Begin processes #>
...
Remove-Variable $variableArray -Scope Global
#>
# End
