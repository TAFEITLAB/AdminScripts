...
$numberOfFiles = Get-Random -Minimum 3 -Maximum 10
Write-Host "Number of files to be created: " $numberOfFiles
$maximumTotalFileSize = $numberOfFiles * '100'
Write-Host "Each file will be a maximum of 100MB, `n for a maximum total of" $maximumTotalFileSize"MB.";
...
While ($i -lt $numberOfFiles) {
    $fileSizeBytes = Get-Random -Minimum 1 -Maximum 104857600;
